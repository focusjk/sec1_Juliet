-- DROP DATABASE `cucarpool`;

-- CREATE USER 'test'@'db' IDENTIFIED WITH mysql_native_password BY '1234';
CREATE DATABASE IF NOT EXISTS cucarpool;
-- ALTER USER test IDENTIFIED BY 1234;
-- ALTER USER 'test'@'db' IDENTIFIED WITH mysql_native_password BY '1234';
CREATE TABLE admin
(
...
departure_longitude decimal(9,6) not null,
